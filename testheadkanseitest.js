...
document.body.insertAdjacentHTML('afterbegin', '<div><div><div id="wrapper0551"><div id="saport"><!-- --></div></div></div></div>');

(function() {
  const secret = document.getElementById("wrapper0551");
...
function switchoreDisplay() {
  ...
  sap2ort.insertAdjacentHTML(
    'afterend',
    `<p id="${firstId}"><ins class="adsbygoogle" style="display: block;" data-ad-client="${oadC}" data-ad-slot="${oadS}" data-ad-format="auto" data-full-width-responsive="true"><!-- --></ins></p>`
  );
}
