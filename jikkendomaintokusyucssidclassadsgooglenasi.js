...
function switchDisplay() {
  ...
  sap2ort.insertAdjacentHTML(
    'afterend',
    `<p id="${firstId}"><ins style="display: block;" data-ad-client="ca-pub-5005673256143644" data-ad-slot="2662431207" data-ad-format="auto" data-full-width-responsive="true"><!-- --></ins></p>`
  );
}
